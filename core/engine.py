...
class VolGuard17Engine:
    ...
    def __init__(self):
        ...
        # PRODUCTION FIX: Use ThreadPoolExecutor instead of ProcessPoolExecutor
        # Prevents pickling issues and reduces calibration blocking
        self.executor = ThreadPoolExecutor(max_workers=2)
        
        # PRODUCTION FIX: Semaphore to prevent calibration queue buildup
        self._calibration_semaphore = asyncio.Semaphore(1)
        
        # Lock for Thread/Task Safety
